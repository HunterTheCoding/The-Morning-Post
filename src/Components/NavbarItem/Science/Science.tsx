...
const Science = () => {
  const { newsData: Science } = useAdmin("Science");
  return (
    <div className=" mt-5">
        <div>
        <h1 className=" text-xl lg:text-[32px] font-bold p-5">Science</h1>
        <hr className="border" />
        </div>
            ...
            return (
              <div>
                <Link to={`/newsdetails/${item._id}`}>
                  <div
                    className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-500 md:col-span-2"
                  ...
                  >
                    ...
                    <h2 className="z-10 p-5">
                      <a
                        ...
                        href="#"
                        className="text-2xl text-white font-bold text-md hover:underline dark:text-gray-100"
                      >
                        {item.headline}
                      </a>
                    </h2>
                ...
                <Link to={`/newsdetails/${item._id}`}>
                  <div className="border-r-2 pr-5 text-black">
                    ...
                    <h2 className="text-blue-700 text-3xl font-bold">
                      Space || <span className="text-2xl">{item.headline}</span>
                    </h2>
                  </div>
                </Link>
              );
                  ...
                  <div className="grid grid-cols-2 mt-10 gap-4">
                    <div>
                      <h2 className="text-blue-700 text-2xl font-bold">
                        Space ||{" "}
                        <span className="text-2xl">{item.headline}</span>
                      </h2>
                    </div>
                    <div>
                      <img className="h-56 w-96" src={item.image} alt="" />
