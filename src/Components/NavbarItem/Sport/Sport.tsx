                                    ...
                                    return (
                                        <div className="" key={index}>
                                            ...
                                            <div className="max-h-96 h-full object-cover overflow-hidden bg-white relative">
                                                <div>
                                                    <img className=" h-full w-full object-cover overflow-hidden" src={item.image} alt="" />
                                                </div>
                                ...
                                return (
                                    <div className="bg-white  first:pr-4 last:pl-4 border-gray-200 first:border-r last:border-l">
                                        ...
                                        <div className="p-5 pl-0">
                                            ...
                                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"><h1>hello orld</h1></p>
                                        </div>
                                    </div>
                                )
                            })
