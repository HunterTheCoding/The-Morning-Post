        ...
        <div className="md:px-6 my-5">
            ...
            <div className="grid md:grid-cols-6 grid-cols-1 gap-4">
                <div className="col-span-4">
                    <div className="grid md:grid-cols-4 grid-cols-1 gap-4">
                        <div className="col-span-3 my-3 flex">
                            <div className="w-1/3 md:h-[200px] bg-gray-200">
                                <h2 className="font-bold lg:text-2xl md:text-xl text-lg  p-2">Severe snowfall in USA. 80 people are died. </h2>
                            </div>
                            <img src={snowImage} className="w-2/3 h-[200px]" alt="" />
                        </div>
                        <div className="md:h-[200px] w-full ml-4 md:ml-0 my-3 bg-gray-200">
                            <img src={israel} className="w-full" alt="" />
                            <h2 className="font-bold p-2">Netaniyahu is destroying Palestine. </h2>
                        </div>

                    </div>
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                        <div className="md:h-[204px] md:my-3 bg-gray-200">
                ...
                <div className="col-span-2">
                    ...
                    <div className="w-2/3 h-[100px] bg-gray-200">
