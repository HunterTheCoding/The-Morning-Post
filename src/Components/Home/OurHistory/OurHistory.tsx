    ...
    return (
        <div className="mt-10 lg:flex ">
            <div className="lg:w-2/3 w-full p-3">
                ...
                <hr className="w-full lg:w-full bg-green-500 mb-3 " />
                <div className="md:flex justify-between w-full  lg:w-full  ">
                    <div className=" w-full lg:w-[50%] ">
                        <Link to="#">
                            <div className=" w-full lg:w-[400px]  bg-base-100 shadow-xl">
                                <figure ><img className="lg:h-[280px] md:h-[350px] h-[175px] w-full lg:w-full" src={p1} alt="pic" /></figure>
            ...
            <div className="w-full md:w-[400px] p-3 mt-5 lg:mt-0 lg:w-1/3 ">
                ...
                <div className="  ">
                    <div className="hero h-[250px] w-full lg:w-full  relative  bg-black  mt-5 " style={{ backgroundImage: `url(${p3})` }}>
