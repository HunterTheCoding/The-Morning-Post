...
import { FaAd, FaDollarSign, FaHome, FaList } from "react-icons/fa";
  ...
  return (
    <div className="md:flex relative z-10">
      <div className="block md:hidden">
        <button className="p-5" onClick={() => settogol(!togol)}>
          {togol ? (
      ...
      <div
        className={` ${
          togol ? "block" : "hidden"
        } absolute z-20  bg-indigo-400 rounded-md ml-2 p-3 `}
      >
        {isAdmin?.isAdmin ? (
          <>
            <ul className="menu  ">
              <li className=" border uppercase text-white rounded-md font-bold text-lg">
                ...
                >
                  <FaHome></FaHome>{" "}
                  <span className=" uppercase  text-center">Profile</span>
                </NavLink>
              </li>
            </ul>
            <ul className="menu ">
          ...
          <>
            <ul className="menu ">
              <li className=" border  rounded-md font-bold  text-lg">
                ...
                >
                  {" "}
                  <FaHome className=" hidden md:block text-xl"></FaHome>
                  <span className="text-[12px] md:text-[18px] font-bold">
                    Profile
                  </span>
                </NavLink>
              </li>
            ...
            <ul className="menu">
              <li className=" border uppercase text-white rounded-md font-bold text-lg">
                ...
                >
                  ...
                  <span className="hidden md:block">Donation</span>
                </NavLink>
              </li>
            </ul>
            <ul className="menu">
